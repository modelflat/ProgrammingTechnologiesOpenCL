...
На **картинке** с сайта openCL представленны крупные компании-члены консорциума, которые учавствуют в разработке или активно используют данную технологию. А, также, интересные и перспективные разработки, базирующиеся на openCL.
...
Тут также представлены логотипы компаний, учавствующих в разработке.
...
Тривиальная программа складывающая два вектора длинны N, реализованная на языке программирования С.\n
 ...
 - Освобождение ресурсов и завершение программы.
  ...
  Исходный код: https://madstrix.github.io/ProgrammingTechnologiesOpenCL/d7/d97/trivial_8c_source.html
...
Исходный код: https://madstrix.github.io/ProgrammingTechnologiesOpenCL/d6/d79/trivial_8cpp_source.html
...
### slide 4.3: **Рассчет интегралла Kotlin**
 ...
 Исходный код: https://bitbucket.org/kirillovoa/openclexample/src/69cf1b5c537044fbb5186cbbdf5bc563224ce32d/src/main/kotlin/org/bitbucket/kirillovoa/openCLExample/ComputeCL.kt?at=master&fileviewer=file-view-default
